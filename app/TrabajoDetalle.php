					              	...
					              	<div class="row">
					              			...
					              			<div class="row">
					              				<div class="col-md-6">
					              					<div class="form-group">
					              						...
					              						<input type="number" value="'.$trabajo->precio.'" name="precio" class="form-control e_precio_t">
					              					</div>
					              				</div>
					              			</div>
					              		</div>
					              		<div class="col-md-4">
					              			<div class="form-group">
					      						...
					      						<input type="number" value="'.$trabajo->precio.'" readonly class="form-control e_subto_t">
					      					</div>
					              		</div>
					              	</div>
					              </div>
