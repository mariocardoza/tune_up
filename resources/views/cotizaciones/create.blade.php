								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" style="height: 29px;" name="fecha" class="form-control fecha" value="{{date('d/m/Y')}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="" class="control-label">Sector</label>
											<input type="text" style="height: 29px;" readonly class="form-control sector">
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" style="height: 29px;" name="kilometraje" class="form-control kilometraje" >
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="" class="control-label">Km próxima</label>
											<input type="number" style="height: 29px;" name="km_proxima" class="form-control kmproxi" readonly>
										</div>
									</div>
								</div>
