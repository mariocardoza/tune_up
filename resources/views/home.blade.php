        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{\App\Cliente::where('estado',1)->count()}}</h3>
              ...
              <a href="{{url('clientes')}}" class="small-box-footer">Ver <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>{{\App\Cotizacione::where('tipo_documento',1)->count()}}</h3>
              ...
              <a href="{{url('cotizaciones/'.$uc)}}" class="small-box-footer">Ver más <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>{{\App\Cotizacione::where('tipo_documento',2)->count()}}</h3>
              ...
              <a href="{{url('facturas/'.$uf)}}" class="small-box-footer">Ver más <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>{{\App\Cotizacione::where('tipo_documento',3)->count()}}</h3>
