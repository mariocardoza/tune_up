		...
		<div class="col-md-12">
			<div class="card card-primary">
				<div class="card-header">
					<div class="row">
						<div class="col-md-4"><a id="anterior" data-id="{{$anterior}}" href="{{url('facturas/'.$anterior)}}" class="btn btn-success"><i class="fas fa-angle-left"></i></a></div>
						<div class="col-md-4"><h3 class="card-title">Consumidor final: <b>{{$cotizacion->correlativo}}</b></h3></div>
						<div class="col-md-4"><a id="siguiente" data-id="{{$siguiente}}" href="{{url('facturas/'.$siguiente)}}" class="btn btn-success float-right"><i class="fas fa-angle-right"></i></a></div>
					</div>
...
@endsection
@section('scripts')
<script src="{{asset('js/facturas_show.js')}}"></script>
